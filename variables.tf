...
locals {
  ...
  argocd_helm_chart_version = "9.4.18"
  glueops_platform_version  = "v0.72.0" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
