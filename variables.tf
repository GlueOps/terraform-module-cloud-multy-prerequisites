...
locals {
  ...
  codespace_version         = "v0.129.0"
  argocd_helm_chart_version = "8.2.7"
  glueops_platform_version  = "feat/adding-placeholders" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
  tools_version             = "v0.34.0"
  calico_helm_chart_version = "v3.30.4"
  calico_ctl_version        = "v3.30.4"
  tigera_operator_version   = "v1.38.7"
  terraform_module_version  = "v0.45.0"
}
