...
locals {
  ...
  glueops_platform_version  = "feat/update-images-to-use-registry-caches" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
