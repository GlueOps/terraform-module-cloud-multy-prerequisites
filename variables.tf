...
locals {
  ...
  argocd_helm_chart_version = "8.5.10"
  glueops_platform_version  = "v0.70.3" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
