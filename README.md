...
| Name | Version |
|------|---------|
| <a name="requirement_autoglue"></a> [autoglue](#requirement\_autoglue) | 0.9.2 |

## Providers

| Name | Version |
|------|---------|
| <a name="provider_autoglue"></a> [autoglue](#provider\_autoglue) | 0.9.2 |
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_argocd_helm_values"></a> [argocd\_helm\_values](#module\_argocd\_helm\_values) | git::https://github.com/GlueOps/docs-argocd.git | v0.17.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_autoglue_credentials"></a> [autoglue\_credentials](#input\_autoglue\_credentials) | The autoglue credentials object | <pre>object({<br/>    autoglue_org_id     = string<br/>    autoglue_key        = string<br/>    autoglue_org_secret = string<br/>    base_url            = string<br/>  })</pre> | n/a | yes |
