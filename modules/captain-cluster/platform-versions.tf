...
locals {
  ...
  platform_crds_version     = "v0.1.3"  # pin of GlueOps/platform-crds (the layer-0 CRD bundle), applied by captain_utils `crds` before argocd and before the platform chart.
