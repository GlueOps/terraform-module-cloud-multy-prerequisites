...
locals {
  ...
  platform_crds_version     = "v0.2.0"  # pin of GlueOps/platform-crds (the layer-0 CRD bundle), applied by captain_utils `crds` before argocd and before the platform chart.
  ...
  terraform_module_version  = "v0.52.0"
