...
locals {
  ...
  glueops_platform_version  = "v0.79.2" # keep in sync with the ?ref= of module.glueops_platform_helm_values in generate-helm-values.tf
  ...
  tigera_operator_version   = "v1.42.4"
