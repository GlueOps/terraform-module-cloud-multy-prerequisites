...
locals {
  ...
  argocd_helm_chart_version = "7.8.23"
  glueops_platform_version  = "v0.56.5" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
