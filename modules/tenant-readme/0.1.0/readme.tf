...
locals {
  ...
  glueops_platform_version  = "v0.34.0-rc11" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
  tools_version             = "v0.5.0"
}
