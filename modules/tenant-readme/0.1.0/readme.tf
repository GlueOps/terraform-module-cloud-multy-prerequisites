...
locals {
  ...
  argocd_helm_chart_version = "5.39.0"
  glueops_platform_version  = "0.21.0" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
