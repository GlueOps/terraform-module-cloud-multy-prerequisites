...
locals {
  ...
  glueops_platform_version  = "chore/updates" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
  tools_version             = "v0.4.1"
}
