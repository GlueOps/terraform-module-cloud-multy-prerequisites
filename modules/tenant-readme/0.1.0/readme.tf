...
locals {
  codespace_version         = "v0.85.1"
  argocd_crd_version        = var.argocd_app_version
  argocd_helm_chart_version = "7.7.23"
  glueops_platform_version  = "v0.56.3" # this also needs to be updated in the module.glueops_platform_helm_values // generate-helm-values.tf
